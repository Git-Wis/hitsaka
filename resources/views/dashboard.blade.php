  ...
  <div class="container-fluid">
      ...
      <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
          ...
          <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
              ...
              <li class="nav-item">
                  <a class="nav-link d-flex align-items-center gap-2" href="{{ route('resa.index') }}">
              ...
              <li class="nav-item">
                  <a class="nav-link d-flex align-items-center gap-2" href="{{ route('bilan.show') }}">
              ...
              <li class="nav-item">
                  <a class="nav-link d-flex align-items-center gap-2" href="{{ route('capital.index') }}">
              ...
              <span>Les reservations de la semaine</span>
